...
public final class FindMeetingQueryTest {
  ...
  public void justEnoughRoomOptional() {
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TimeRange.END_OF_DAY, true),
            Arrays.asList(PERSON_A)),
        new Event("Event 3", TimeRange.fromStartEnd(TIME_0830AM, TIME_0945AM, false),
            Arrays.asList(PERSON_B)));
  ...
  @Test
  public void optionalAttendeesFree() {
    // Add two optional attendees with a gap in their schedules. This gap should be returned.
    Collection<Event> events = Arrays.asList(new Event("Event 1",
        TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false), Arrays.asList(PERSON_A)),
  ...
  public void optionalAttendeesNotFree() {
    // Add two optional attendees with no gap in their schedules. No gap should be returned
    Collection<Event> events = Arrays.asList(new Event("Event 1",
        TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0900AM, false), Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TimeRange.END_OF_DAY, true), Arrays.asList(PERSON_B)));
